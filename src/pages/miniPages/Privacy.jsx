export default function privacypolicy() {
  return (
    <div className="max-w-3xl bg-white mx-auto p-8 mt-8">
      ...
      <small>Last updated: October 27, 2024</small>
      <br />
      <br />
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to TrendinGlobes.
          </p>
        </li>
        <br />
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to TrendinGlobes, accessible from{" "}
            <a
              href="trendinglobes.com"
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            Type: Persistent CookiesAdministered by: Us Purpose: These Cookies
        ...
        <li>
          <p>
            ...
            CookiesAdministered by: Us Purpose: These Cookies allow us to
      ...
      <ul>
        <li>
          ...
          <a
            href="http://127.0.0.1:5173/contact-us"
            rel="external nofollow noopener"
            target="_blank"
          >
